...
def main(cfg_file):
    ...
    #Converts action space string to enum
    params["settings"]["action_space"] = SpaceTypes.DISCRETE if params["settings"]["action_space"] == "discrete" else SpaceTypes.MULTI_DISCRETE
    
    #parse settings and wrappers settings
    ...
    #Gets ppo policy and training hyperparams
    ...
    #Initialize PPO agent or load from checkpoint
